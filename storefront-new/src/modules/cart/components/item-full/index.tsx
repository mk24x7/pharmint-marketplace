      ...
      <div className="flex gap-x-4 items-start">
        <LocalizedClientLink href={`/products/${item.product_handle}`}>
          <Thumbnail
            ...
            size="square"
            type="full"
            className="bg-background-secondary rounded-lg w-20 h-20"
          />
        </LocalizedClientLink>
        <div className="flex flex-col gap-y-2 justify-between min-h-full self-stretch">
          <div className="flex flex-col">
            <span className="text-pharmint-muted text-[0.6rem]">BRAND</span>

            <span className="txt-medium-plus text-white">
              {item.product?.title}
            </span>
            <span className="text-pharmint-muted text-xs">
              {item.variant?.title}
            </span>
          </div>
          <div className="flex small:flex-row flex-col gap-2">
            ...
            <div className="flex gap-x-2">
              <div className="flex gap-x-3 border border-pharmint-border rounded-full w-fit p-px items-center">
                <button
                  className={clx(
                    "w-4 h-4 flex items-center justify-center text-pharmint-muted hover:bg-accent/20 rounded-full text-md",
                ...
                <span className="w-4 h-4 flex items-center justify-center text-white text-xs">
                  {updating ? (
                    <Spinner size="12" />
                  ) : (
                    <Input
                      className={clx(
                        "w-10 h-4 flex items-center justify-center text-center text-white text-xs [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none bg-transparent shadow-none",
                        disabled
