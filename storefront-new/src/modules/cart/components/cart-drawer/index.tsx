      ...
      >
        <Drawer.Trigger asChild>
          <button className={clx(
            "transition-fg relative inline-flex w-fit items-center justify-center overflow-hidden outline-none txt-compact-small-plus gap-x-1.5 px-3 py-1.5 rounded-full border border-transparent hover:bg-accent/20 hover:border-accent/30 active:bg-accent/30 focus:bg-accent/20 focus:border-accent/50 focus:outline-none transition-all duration-200",
            isCartPage 
            ...
            <div className="bg-accent text-white text-xs px-1.5 py-px rounded-full">
              {totalItems}
            </div>
          </button>
        </Drawer.Trigger>
