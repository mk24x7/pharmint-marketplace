...
function FreeShippingInline({
  ...
  return (
    <div className="bg-background-secondary border border-pharmint-border p-2 rounded-lg">
      <div className="space-y-1.5">
        <div className="flex justify-between text-xs text-pharmint-muted">
          <div>
        ...
        <div className="flex justify-between gap-1">
          <div
            className={clx(
              "bg-gradient-to-r from-pharmint-border to-pharmint-muted h-1 rounded-full max-w-full duration-500 ease-in-out",
              {
          ...
          ></div>
          <div className="bg-pharmint-border h-1 rounded-full w-fit flex-grow"></div>
        </div>
      </div>
    </div>
  )
...
function FreeShippingPopup({
  ...
  return (
    ...
    >
      <div>
        <Button
          className="rounded-full bg-background-secondary shadow-none outline-none border-none text-[15px] p-2"
      ...
      <div className="w-[400px] bg-black text-white p-6 rounded-lg ">
        <div className="pb-4">
          <div className="space-y-3">
            <div className="flex justify-between text-[15px] text-pharmint-muted">
              <div>
                {price.target_reached ? (
                  <div className="flex items-center gap-1.5">
                    <CheckCircleSolid className="text-green-500 inline-block" />{" "}
            ...
            <div className="flex justify-between gap-1">
              <div
                className={clx(
                  "bg-gradient-to-r from-pharmint-border to-pharmint-muted h-1.5 rounded-full max-w-full duration-500 ease-in-out",
                  {
                    "from-green-400 to-green-500": price.target_reached,
                  }
                )}
                style={{ width: `${price.remaining_percentage}%` }}
              ></div>
              <div className="bg-pharmint-border h-1.5 rounded-full w-fit flex-grow"></div>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-3">
          <LocalizedClientLink
            className="rounded-2xl bg-transparent shadow-none outline-none border-[1px] border-pharmint-border text-[15px] py-2.5 px-4"
            href="/cart"
          >
            View cart
          </LocalizedClientLink>
          ...
          <LocalizedClientLink
            className="flex-grow rounded-2xl bg-accent text-white shadow-none outline-none border-[1px] border-accent text-[15px] py-2.5 px-4 text-center"
            href="/store"
          >
            View Products
          </LocalizedClientLink>
