...
const Employee = ({
  ...
  return (
    <div className="flex flex-col">
      <div className="flex justify-between p-4 border-b border-pharmint-border">
        <div className="flex flex-col">
          ...
          <div className="flex gap-x-2 small:flex-row flex-col">
            <Text className=" text-pharmint-muted">{employee.customer.email}</Text>
            <Text className=" text-pharmint-muted hidden small:block">
              {" • "}
            </Text>
            <Text className=" text-pharmint-muted">{employee.customer.phone}</Text>
            <Text className=" text-pharmint-muted hidden small:block">
              {" • "}
            </Text>
      ...
      <form
        className={clx(
          "bg-background-secondary grid grid-cols-2 gap-4 border-b border-pharmint-border transition-all duration-300 ease-in-out",
          {
      ...
      >
        <div className="flex flex-col gap-y-2">
          <Text className=" text-white font-medium">Spending Limit</Text>
          <CurrencyInput
            symbol={currencySymbolMap[company.currency_code!]}
            code={company.currency_code!}
            className="bg-background-secondary border border-pharmint-border rounded-full"
            name="spending_limit"
