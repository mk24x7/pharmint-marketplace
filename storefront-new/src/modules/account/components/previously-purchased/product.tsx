  ...
  return (
    <Container className="flex justify-between items-center">
      <div className="flex gap-2">
        <div className="w-14 h-14 rounded-md overflow-hidden bg-background-secondary border border-pharmint-border">
          <Thumbnail thumbnail={thumbnail} size="square" />
        </div>
        <div className="flex flex-col justify-center">
          <Text className="text-lg text-white">{product_title}</Text>
          <Text className="text-sm text-pharmint-muted">{title}</Text>
        </div>
      </div>
