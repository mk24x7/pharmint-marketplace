  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="z-[100] data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-background-secondary border border-pharmint-border p-[25px] shadow-lg focus:outline-none">
          <Dialog.Title className="text-lg mb-6 flex justify-between text-white font-semibold">
          ...
          <div className="flex flex-col gap-y-4 text-pharmint-white">
            <p>
