...
export async function signup(_currentState: unknown, formData: FormData) {
  ...
  const customerForm = {
    ...
    company_name: formData.get("company_name") as string || "Default Company",
  }
  ...
  try {
    ...
    const companyForm = {
      name: formData.get("company_name") as string || "Default Company",
      email: formData.get("email") as string,
      ...
      country: formData.get("company_country") as string || "Philippines",
